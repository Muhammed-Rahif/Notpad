...
(function ($) {
  ...
  let HighlightWithinTextarea = function (this:any,$el:any, config:any) {
    this.init($el, config);
  };

  HighlightWithinTextarea.prototype = {
    init: function (this:any,$el:any, config:any) {
      this.$el = $el;
    ...
    getRanges: function (input:any, highlight:any) {
    ...
    getArrayRanges: function (input:any, arr:any) {
      let ranges = arr.map(this.getRanges.bind(this, input));
      return Array.prototype.concat.apply([], ranges);
    },

    getFunctionRanges: function (input:any, func:any) {
      return this.getRanges(input, func(input));
    },

    getRegExpRanges: function (input:any, regex:any) {
      let ranges = [];
      let match;
    ...
    getStringRanges: function (input:any, str:any) {
      let ranges = [];
    ...
    getRangeRanges: function (input:any, range:any) {
      return [range];
    },

    getCustomRanges: function (input:any, custom:any) {
    ...
    removeStaggeredRanges: function (ranges:any) {
      let unstaggeredRanges:any = [];
      ranges.forEach(function (range:any) {
        let isStaggered = unstaggeredRanges.some(function (unstaggeredRange:any) {
          let isStartInside =
    ...
    getBoundaries: function (ranges:any) {
      let boundaries:any = [];
      ranges.forEach(function (range:any) {
        boundaries.push({
          type: "start",
    ...
    sortBoundaries: function (boundaries:any) {
      // backwards sort (since marks are inserted right to left)
      boundaries.sort(function (a:any, b:any) {
        if (a.index !== b.index) {
    ...
    renderMarks: function (boundaries:any) {
      let input = this.$el.val();
      boundaries.forEach(function (boundary:any, index:any) {
        let markup;
  ...
  ($.fn as any).highlightWithinTextarea = function (options:any) {
    return this.each(function (this:any,) {
      ...
      if (typeof options === "string") {
        ...
        plugin = new (HighlightWithinTextarea as any)($this, options);
